...
var DAY_BEFORE_DAYLIGHT_SAVINGS = '2017-03-11';
    ...
    testInvalidRepeats([
      {
        ...
        outputAttributes: {'data-due': DAY_BEFORE_DAYLIGHT_SAVINGS, 'data-repeat': 'Error: invalid repeat value'},
      },
      {
      ...
      },
      {
        ...
        outputAttributes: {'data-due': 'foobar', 'data-repeat': 'Error: invalid due date'},
      },
      {
        description: 'invalid start date',
        currentDate: DAY_BEFORE_DAYLIGHT_SAVINGS,
        inputAttributes: {'data-start': 'foobar', 'data-repeat': 'Monday'},
        outputAttributes: {'data-start': 'foobar', 'data-repeat': 'Error: invalid start date'},
      },
      {
        description: 'no "data-start" or "data-due"',
        currentDate: DAY_BEFORE_DAYLIGHT_SAVINGS,
        inputAttributes: {'data-repeat': 'Monday'},
        outputAttributes: {'data-repeat': 'Error: start or due required'},
      },
    ]);
  });
